 ...
 *
 * This file contains class ES_Admin_Add_Pages that builds theme option pages
 * in the wp-admin
 *
 * @package boilerplate
 */
if( class_exists( 'ES_Admin_Pages' ) ) {
	class ES_Admin_Add_Sub_Pages extends ES_Admin_Pages {
	...
	} // End ES_Admin_Add_Sub_Pages class
}// End if( class_exists() )